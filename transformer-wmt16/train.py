...
def train(model, training_data, validation_data, optimizer, scheduler, device, opt, writer):
    ''' Start training '''
    ...
    for epoch_i in range(opt.epoch):
        ...
        writer.add_scalar('ppl/train', math.exp(min(train_loss, 100)), epoch_i)
        writer.add_scalar('ppl/val',   math.exp(min(valid_loss, 100)), epoch_i)
